    ...
    BY TODAY'S NEEDS
        ...
        <div data-aos="fade-up" className={classes.mainTextWrapper}>
            ...
            <div className={classes.checkFutureWrapper}>
                <Button onClick={() => handleNavigate('/about-us')} type='plain'>
...
<div className={classes.CreateImg}>
    ...
    <div className={classes.createContainerMobile}>
        <div className={classes.homeCreateMobile}>
          <h2 data-aos="fade-up" className={classes.headingMobile}>
            CREATING TOMORROW'S<br />
            <motion.span> SPACES, INSPIRED BY</motion.span> <br />
          ...
          <div data-aos="fade-up" className={classes.mobileTextWrapper}>
