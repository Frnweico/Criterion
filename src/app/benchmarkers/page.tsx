...
export const metadata: Metadata = pageMetadata("/benchmarkers", "The Benchmarkers", "Join The Benchmarkers for early access to selected Criterion Homes developments and private project updates.");
